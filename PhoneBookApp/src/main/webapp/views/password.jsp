...
<h3 style="    font-family: ui-serif;">Change Password <i class="fa-solid fa-key"></i></h3>
<h6 style="color: red">${NOTIFICATION}</h6>
		<form action="${pageContext.request.contextPath}/ContactServlet"
			...
			<div class="form-group">
				New Password:- <input type="text" name="password1" value="" placeholder="Enter New Password" style="background: gainsboro;"autofocus="autofocus">
			</div>

			<div class="form-group">
				Confirm Password :- <input type="text" name="password2" value="" placeholder="Confirm Password"  style="background: gainsboro;" >
			</div>
			<input type="hidden" name="action" value="CNGPASS">
			<button type="submit" class="btn btn-primary">Submit <i class="fa-solid fa-right-to-bracket"></i></button>
		</form>
	</div>
